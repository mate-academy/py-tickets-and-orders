# Generated by Django 4.0.2 on 2023-11-07 17:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='ticked',
            name='movie_session',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tickeds', to='db.moviesession'),
        ),
        migrations.AddField(
            model_name='ticked',
            name='order',
        ...
        migrations.AddConstraint(
            model_name='ticked',
            constraint=models.UniqueConstraint(fields=('movie_session', 'row', 'seat'), name='unique_ticked'),
        ),
    ]
