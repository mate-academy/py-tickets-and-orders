# Generated by Django 4.0.2 on 2024-07-24 20:56
...
class Migration(migrations.Migration):
    ...
    replaces = [('db', '0001_initial'), ('db', '0002_user_order_ticket_alter_movie_actors_and_more'), ('db', '0003_alter_order_options'), ('db', '0004_alter_order_options')]
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='ticket',
            constraint=models.UniqueConstraint(fields=('movie_session', 'row', 'seat'), name='movie_session_ticket_constraint'),
        ),
