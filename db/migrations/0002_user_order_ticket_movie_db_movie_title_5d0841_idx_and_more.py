# Generated by Django 4.0.2 on 2022-08-16 17:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='ticket',
            constraint=models.UniqueConstraint(fields=('row', 'seat', 'movie_session'), name='Unique place in cinema hall for unique movie session'),
        ),
    ]
