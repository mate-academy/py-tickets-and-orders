# Generated by Django 4.0.2 on 2023-10-29 19:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='ticket',
            name='movie_session',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='db.moviesession'),
        ),
        migrations.AddField(
            model_name='ticket',
            name='order',
        ...
        migrations.AddConstraint(
            model_name='ticket',
            constraint=models.UniqueConstraint(fields=('row', 'seat', 'movie_session'), name='unique row, seat, session'),
        ),
    ]
