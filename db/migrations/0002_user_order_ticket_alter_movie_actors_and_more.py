# Generated by Django 4.0.2 on 2024-02-09 16:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='genre',
            index=models.Index(fields=['name'], name='db_genre_name_5846e3_idx'),
        ),
        migrations.AddField(
            model_name='ticket',
            name='movie_session',
        ...
        migrations.AddConstraint(
            model_name='ticket',
            constraint=models.UniqueConstraint(fields=('row', 'seat', 'movie_session'), name='unique_row_seats_session'),
        ),
    ]
