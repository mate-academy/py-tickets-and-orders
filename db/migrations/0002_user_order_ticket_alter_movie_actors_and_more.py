# Generated by Django 4.0.2 on 2023-11-08 14:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='ticket',
            constraint=models.UniqueConstraint(fields=('movie_session', 'row', 'seat'), name='seat and row must be unique for movie session'),
        ),
    ]
