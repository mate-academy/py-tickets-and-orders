# Generated by Django 4.0.2 on 2023-11-10 06:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='movie',
            index=models.Index(fields=['title'], name='name_age_indexes'),
        ),
        migrations.AddField(
            model_name='ticket',
            name='movie_session',
        ...
        migrations.AddConstraint(
            model_name='ticket',
            constraint=models.UniqueConstraint(fields=('row', 'seat', 'movie_session'), name='unique_row_set_movie'),
        ),
    ]
