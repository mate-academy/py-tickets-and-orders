# Generated by Django 4.0.2 on 2023-10-31 22:13
...
class Migration(migrations.Migration):
    ...
    replaces = [('db', '0001_initial'), ('db', '0002_user_orders_alter_movie_actors_alter_movie_genres_and_more'), ('db', '0003_rename_orders_order')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='db.orders')),
            ],
            options={
