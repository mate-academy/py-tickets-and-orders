# Generated by Django 4.0.2 on 2023-03-16 09:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='ticket',
            constraint=models.UniqueConstraint(fields=('row', 'seat', 'movie_session'), name='Unique value for seat and row for one movie session'),
        ),
    ]
