# Generated by Django 4.0.2 on 2023-09-14 20:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='movie',
            index=models.Index(fields=['title'], name='indexed_title'),
        ),
        migrations.AddField(
            model_name='ticket',
            name='movie_session',
        ...
        migrations.AddConstraint(
            model_name='ticket',
            constraint=models.UniqueConstraint(fields=('row', 'seat', 'movie_session'), name='unique_ticket_rows_seats_sessions'),
        ),
    ]
