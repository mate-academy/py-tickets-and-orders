# Generated by Django 4.0.2 on 2023-05-12 21:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie_session', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='db.moviesession')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='db.order')),
            ],
        ),
        migrations.AddConstraint(
            model_name='ticket',
            constraint=models.UniqueConstraint(fields=('seat', 'row', 'movie_session_id'), name='Unique seat and row and movie_session'),
        ),
        migrations.AddIndex(
            model_name='movie',
